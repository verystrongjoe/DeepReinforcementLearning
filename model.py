...
class GenModel:
	...
	def update(self, states, targets):
		...
		:return:
		# todo : add parameter verbose, epochs, split_ratio to split validation
		"""
		...
		actor_loss = self.loss_weight['policy_head'] * torch.mean(p_loss)
		...
		critic_loss = self.loss_weight['value_head'] * v_loss
